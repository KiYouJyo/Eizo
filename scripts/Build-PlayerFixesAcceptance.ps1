...
$signedDir = Join-Path $env:RUNNER_TEMP 'Eizo-player-fixes-signed'
...
$signedMsix = Join-Path $signedDir 'Eizo_0.2.0.0_x64_player-fixes.msix'
...
Write-Host "Signed player-fixes package ready: $signedMsix"
