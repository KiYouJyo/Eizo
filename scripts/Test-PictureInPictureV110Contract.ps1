...
Assert-Contains $player '_engine?.Tracks.SelectedSubtitleTrackId is not null;' 'embedded subtitle detection'
Assert-Contains $player 'ApplyPictureInPictureTopSubtitlePosition(' 'secondary subtitle top placement with embedded subtitles'
Assert-Contains $player 'surfaceHeight - overlayHeight - topInset' 'top subtitle geometry'
