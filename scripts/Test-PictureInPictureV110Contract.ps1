...
Assert-Contains $player 'PrimarySubtitleText.FontSize = 16d;' 'compact primary subtitle size'
Assert-Contains $player 'SecondarySubtitleText.FontSize = 14d;' 'compact secondary subtitle size'
