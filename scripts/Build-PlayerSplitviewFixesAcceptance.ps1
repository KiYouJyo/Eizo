...
$signedDir = Join-Path $env:RUNNER_TEMP 'Eizo-player-splitview-fixes-signed'
...
$signedMsix = Join-Path $signedDir 'Eizo_0.2.0.0_x64_player-splitview-fixes.msix'
...
Write-Host "Signed player-splitview-fixes package ready: $signedMsix"
