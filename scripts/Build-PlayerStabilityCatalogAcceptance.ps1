...
$signedDir = Join-Path $env:RUNNER_TEMP 'Eizo-player-stability-catalog-signed'
...
$signedMsix = Join-Path $signedDir 'Eizo_0.2.0.0_x64_player-stability-catalog.msix'
...
Write-Host "Signed player-stability-catalog package ready: $signedMsix"
