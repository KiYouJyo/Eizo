...
$signedDir = Join-Path $env:RUNNER_TEMP 'Eizo-player-ui-signed'
...
$signedMsix = Join-Path $signedDir 'Eizo_0.2.0.0_x64_player-ui.msix'
...
Write-Host "Signed player-ui package ready: $signedMsix"
