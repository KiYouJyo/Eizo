...
$bundleOutput = Join-Path $env:RUNNER_TEMP 'Eizo-v0.3.0.1-AppPackages'
...
$artifactDir = Join-Path $env:RUNNER_TEMP 'Eizo-v0.3.0.1-UI-acceptance'
...
$cer = Join-Path $artifactDir 'Eizo-v0.3.0.1-AppPublisher.cer'
...
if (-not $pkg -or [string]$pkg.Version -ne '0.3.0.1') {
    throw 'Eizo v0.3.0.1 UI acceptance package was not registered correctly.'
}
...
Write-Host "Eizo v0.3.0.1 UI acceptance package ready: $signedBundle"
