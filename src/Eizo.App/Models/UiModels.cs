...
public sealed record SourceItemModel(string Id, string Name, string Summary, string Kind, bool Removable = false, bool IsScanning = false, bool CanScan = true, string ScanText = "", double ScanProgressSize = 0, double ScanSpacing = 0);
