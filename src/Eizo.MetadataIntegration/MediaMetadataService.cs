...
public sealed record MediaMetadataServiceOptions(
    ...
    string BangumiUserAgent = "KiYouJyo/Eizo/0.5.10 (https://github.com/KiYouJyo/Eizo)",
    string PreferredLanguage = "zh-CN",
    string? TmdbReadAccessToken = null,
    string? CacheDirectory = null,
    bool EnableArtworkProviders = true,
    string AniListUserAgent = "KiYouJyo/Eizo/0.5.10 (https://github.com/KiYouJyo/Eizo)");
